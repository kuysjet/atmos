...
INSERT INTO `user_types` (`id`, `user`, `created_at`, `updated_at`) VALUES
(1, 'Student', '2023-11-25 13:29:37', NULL),
(2, 'Registrar', '2023-11-25 13:29:37', NULL),
(3, 'Administrator', '2023-11-25 13:29:37', NULL);
...
ALTER TABLE `users`
  ...
  ADD KEY `user_type_2` (`user_type_id`),
